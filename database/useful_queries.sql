...
#latest grasp (seen working on the coke can - slips after roughly 10s)
insert into grasp
...
select 1717999,18744,'{-14,0,0,14,0,0,-10,0,0,0,-10,0,0,0,70,0,0,0}','{-14,31,66,14,40,61,-10,35,50,10,-10,45,70,15,70,0,5,5}',1,'{-0.075,-0.06,0.36,0.321,0.542,0.628,0.456}','{-0.05,-0.05,0.23,0.321,0.542,0.628,0.456}',4,0,true,'SHADOW_HAND',0,false,-1,1,false
