...
from handle_demo_step_actions.msg import ObjectRecognitionActionFeedback  


class ObjectRecognitionControl(SequenceStep):
    ...
    def feedback_subscription(self):
        self.feedback_listener = rospy.Subscriber('recognise_objects/feedback', ObjectRecognitionActionFeedback, self.feedback_callback)
